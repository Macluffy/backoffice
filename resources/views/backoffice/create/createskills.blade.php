...
@endif
<h1  class="text-center" style="margin: 150px"> BACK OFFICE | Create Skill</h1>
<div style="margin-left: 40%">
    <form class="m-5" action="{{route('store2')}}" method="post">
        @csrf
        Nom: <input type="text" name="nom" value="{{old('nom')}} " >
        Pourcentage: <input type="number" name="pourcentage" value="{{old('pourcentage')}} ">
